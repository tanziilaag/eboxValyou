										...
										while ($data = mysqli_fetch_array($result)): ?>
											<tr>
												<td class="py-1 produk">
													<a href="stockOut.php?id=<?= $data['id']; ?>">
														<div class="center-v">
															...
															<div style="margin-left: 20px;" class="left">
																<p style="font-size:16px;" class="my-1">
															...
															<div class="right">
																<p
																	style="font-size:20px;color:#194FB1; margin-bottom: -10px; ">
																	<?= $data['jumlah'] ?>
																</p>
																<p
																	style="font-size:16px;color: red; margin-bottom: 0; float: right;">
																	<?php if (isset($_POST['submit']) and $data['id'] === $id and $_POST['jumlah'] > 0 and $_POST['jumlah'] <= $jumlahProd) {
																		echo "- " . $_POST['jumlah'];
																	} ?>
																</p>
															</div>
												...
												<p style="color: black;">
													<strong>
														...
														Jumlah Keluaran : <span style="color:red;">
															<?php if (isset($_POST['submit']) and $_POST['jumlah'] > 0 and $_POST['jumlah'] <= $jumlahProd) {
																echo $_POST['jumlah'];
															} ?>
														</span>
													</strong>
